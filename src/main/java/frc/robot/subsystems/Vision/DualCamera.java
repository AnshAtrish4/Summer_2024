...
public class DualCamera {
    ...
    private static final Transform3d FRONT_CAMERA_OFFSET = new Transform3d(
        new Translation3d(0.0, 0.0, 0.0), new Rotation3d(0.0, Math.toRadians(30), Math.toRadians(0.0))
    );
    private static final Transform3d BACK_CAMERA_OFFSET = new Transform3d(
        new Translation3d(-0.65, 0.15, 0.0), new Rotation3d(0.0, Math.toRadians(30), Math.PI)
    );
